        ...
        <html>
            ...
            <body class="ph3 pb3 mid-gray">
                <header class="mw8 pv4 center">
                    ...
                    <p>
                        Generated by <a href="https://boltcms.io">Bolt</a>, this is an XML sitemap, meant for consumption by search engines.<br/>
    ...
    <xsl:template match="sitemap:sitemapindex">
        <div class="mw8 center">
            <div class="overflow-auto">
                <table class="w-100 f6 b--silver" cellspacing="0">
                    <thead class="bg-silver">
                        <tr>
                            <th class="pa1 fw6 tl dark-gray" style="width:60px"></th>
                            <th class="pa1 fw6 tl dark-gray">URL</th>
                            <th class="pa1 fw6 tr dark-gray" style="width:200px">Last Modified</th>
                        </tr>
                    </thead>
                    ...
                    <thead class="bg-silver">
                        <tr>
                            ...
                            <xsl:if test="sitemap:url/sitemap:changefreq">
                                <th class="pa1 fw6 tr dark-gray" style="width:130px">Change Freq.</th>
                            </xsl:if>
                            <xsl:if test="sitemap:url/sitemap:priority">
                                <th class="pa1 fw6 tr dark-gray" style="width:90px">Priority</th>
                            </xsl:if>
